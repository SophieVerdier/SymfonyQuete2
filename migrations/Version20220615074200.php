 ...
 */
final class Version20220615074200 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE program CHANGE title title VARCHAR(255) DEFAULT NULL, CHANGE synopsis synopsis LONGTEXT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE program CHANGE title title VARCHAR(255) NOT NULL, CHANGE synopsis synopsis LONGTEXT NOT NULL');
    }
}
